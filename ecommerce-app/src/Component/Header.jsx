                        ...
                        <nav class="navbar navbar-expand">
                            ...
                            <div class="user-box dropdown">
                                <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    <img src="assets/images/avatars/avatar-2.png" class="user-img" alt="user avatar" />
                                    {
                                        ...
                                        <div class="user-info ps-3">
                                            <p class="user-name mb-0">{user && user.name}</p>
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    <li>
                                        <a class="dropdown-item" href="user-profile.html"><i class="bx bx-user"></i><span>Profile</span></a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item" href="ecommerce-orders.html"><i class="bx bx-cog"></i><span>Orders</span></a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item" href="index.html"><i class="bx bx-home-circle"></i><span>Dashboard</span></a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item" href="earnings.html"><i class="bx bx-dollar-circle"></i><span>Earnings</span></a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item" href="downloads.html"><i class="bx bx-download"></i><span>Downloads</span></a>
                                    </li>
                                    <li>
                                        <div class="dropdown-divider mb-0"></div>
                                    </li>
                                    <li>
                                        <Link class="dropdown-item" onClick={heandleChange} to='/login'><i class="bx bx-log-out-circle"></i><span>Logout</span></Link>
                                    </li>
                                </ul>
                            </div>
                        </nav>
